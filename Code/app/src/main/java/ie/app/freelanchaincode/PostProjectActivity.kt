...
class PostProjectActivity : AppCompatActivity() {
    ...
    private fun onSubmitButtonClick(
        ...
        FirebaseFirestore.getInstance().collection("User")
            ...
            .addOnSuccessListener { document ->
                if (document != null) {
                    ...
                    val newProject = ProjectModel(
                        ...
                        owner = userName,
                        name = name, // Get name from Firestore
                    ...
                    FirebaseFirestore.getInstance().collection("Project")
                        .document(projectDocId).collection("item").document(id).set(newProject)
            ...
            Toast.makeText(this@PostProjectActivity, "Failed to get user data", Toast.LENGTH_SHORT)
                .show()
        }
    }
